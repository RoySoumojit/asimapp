...
exports.getAllData=async(req,res,next)=>{
    try{
        ...
        let val=await admin.firestore().collection('jeemainquestions')
...
exports.displayAnswerSheet=async(req,res)=>{
    try{
        let useranswer=req.session.userjeemainanswer
        if(!useranswer){
            res.render('jeemain/resultTable',{answer:null,error:"No user data found"})
        }else{
        let val=await admin.firestore().collection("jeemainquestions")
        ...
        if(!val.empty){
            ...
            res.render('jeemain/resultTable',{answer:temp,error:null,total:total})
        }else{
            res.render('jeemain/resultTable',{answer:null,error:"No data found"})
        }
    }
    }catch(Err){
        res.render('jeemain/resultTable',{answer:null,error:Err.message})
    }
}